...
export default function EditPlaylistModal({ isOpen, onClose, playlist }: EditPlaylistModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-lg">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-gray-900 dark:text-white">Edit Playlist</DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-gray-900 dark:text-white">Playlist Name</Label>
            <Input
              id="name"
              value={name}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="border-gray-300 dark:border-gray-700 dark:bg-gray-800 min-h-[100px]"
            />
          </div>
