...
export default function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "h-[calc(100vh-4rem)] sticky top-16 bg-white dark:bg-black transition-all duration-300 ease-in-out overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-700 hidden md:block",
        expanded ? "w-64" : "w-20"
      )}
    >
      <div className="p-1">
